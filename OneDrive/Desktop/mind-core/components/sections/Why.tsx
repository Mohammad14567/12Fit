...
/**
 * Why Mind Core — the section people remember.
 *
 * A 300vh pinned scene. The Core, gone since the hero, re-condenses at the
 * center of the screen, and three beliefs pass through it like thoughts.
 * The reader scrolls *through* the studio's mind. No bullet points — a story.
 */
export default function Why() {
  ...
  // The Core condenses in, holds, then settles
  ...
  // Rings + rail share the Core's arrival
  ...
  return (
    <section ref={ref} id="why" aria-label="Why Mind Core" className="relative h-[300vh]">
      <div className="sticky top-0 flex h-screen items-center justify-center overflow-hidden px-6">
        ...
        {/* Concentric HUD rings orbiting the Core */}
        <motion.div
          aria-hidden
        ...
        <div
          aria-hidden
          className="absolute right-7 top-1/2 hidden h-40 w-px -translate-y-1/2 bg-hairline md:block"
        >
          <motion.div
        ...
        <motion.p
          ...
          className="label absolute top-24 left-1/2 -translate-x-1/2"
        >
          04 · Why Mind Core
        </motion.p>

        {/* Beliefs pass through the light */}
...
function Belief({
  ...
  // Each belief owns a slice of the scroll; it rises in, holds, drifts out.
