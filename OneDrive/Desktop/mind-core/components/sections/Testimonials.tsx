...
/**
 * Testimonials — one voice at a time, set like a quotation in a keynote.
 * A thin light-line under the quote charges as the timer runs, then the next
 * voice arrives. Manual control via the speaker index; auto-advance pauses
...
export default function Testimonials() {
  ...
  return (
    ...
    >
      {/* a soft pool of light behind the quote */}
      <div aria-hidden className="bloom-soft absolute left-1/2 top-1/2 h-[28rem] w-[44rem] -translate-x-1/2 -translate-y-1/2" />

      <div className="relative mx-auto max-w-3xl">
        <SectionHeader eyebrow="05 · Voices" title="What it's like, from their side." align="center" />

        <div className="glass edge-light scanlines relative mt-16 overflow-hidden rounded-3xl px-8 py-14 sm:px-14 sm:py-16">
          {/* Oversized quotation glyph, lit from the pool below */}
          <span
            aria-hidden
            className="display pointer-events-none absolute -top-6 left-6 select-none text-[9rem] leading-none text-beam/10 sm:left-10"
          >
            “
          </span>
        ...
        {/* Speaker control — charging light lines */}
